// P1.6 (AUDIT-R2): materialized metrics layer — Studio's `/metrics` and `/metrics/runs`
...
/**
 * P2-skor (AUDIT-R2): prefix for `recordRunScores`'s OWN exactly-once claim marker —
...
/**
 * P2-skor (AUDIT-R2): records ONE completed run's C4 scorer output as a SECOND, ADDITIVE
