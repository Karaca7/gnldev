// @gnl/cli programmatic surface (for defineConfig inside gnl.config.ts + for tests/embedding).
...
// Runtime resolver (@gnl/durable/server/studio/memory/auth/hono/@hono-node-server resolved from the
// TARGET PROJECT, not bundled with @gnl/cli) — for embedding that needs to drive buildDevApp directly.
