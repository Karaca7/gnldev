...
> Install: `pnpm add @gnldev/studio` — it ships with the prebuilt UI bundle the inspector serves. (Or build both from a [repo clone](https://github.com/Karaca7/gnldev): `pnpm install && pnpm -r build`.)
